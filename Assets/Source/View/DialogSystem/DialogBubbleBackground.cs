...
{
    public sealed class DialogBubbleBackground : SerializedMonoBehaviour
    {
        [Header("Objects")]
        ...
        private void FixedUpdate() 
        {
            ...
            _rect.position = _camera.WorldToScreenPoint(_playerTransform.position + new Vector3(0, 0.5f)) + new Vector3(0, 75 + _rect.sizeDelta.y / 2 * 1.55f);
